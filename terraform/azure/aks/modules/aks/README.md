...
| <a name="input_node_pools"></a> [node\_pools](#input\_node\_pools) | Addons node pools | <pre>list(object({<br>    name                   = string<br>    agents_vm_size         = string<br>    agents_os_disk_size_gb = number<br>    agents_os_disk_type    = string<br>    enable_auto_scaling    = bool<br>    agents_count           = number<br>    agents_min_count       = number<br>    agents_max_count       = number<br>    agents_max_pods        = number<br>    agents_taints          = list(string)<br>    agents_labels          = map(string)<br>    agents_tags            = map(string)<br>  }))</pre> | `[]` | no |
