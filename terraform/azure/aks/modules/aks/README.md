...
| Name | Type |
|------|------|
| [azurerm_resource_group.aks](https://registry.terraform.io/providers/hashicorp/azurerm/2.87.0/docs/resources/resource_group) | resource |
| [azurerm_application_gateway.this](https://registry.terraform.io/providers/hashicorp/azurerm/2.87.0/docs/data-sources/application_gateway) | data source |
| [azurerm_subnet.aks](https://registry.terraform.io/providers/hashicorp/azurerm/2.87.0/docs/data-sources/subnet) | data source |
| [azurerm_subnet.application_gateway](https://registry.terraform.io/providers/hashicorp/azurerm/2.87.0/docs/data-sources/subnet) | data source |
...
| <a name="input_application_gateway_resource_group_name"></a> [application\_gateway\_resource\_group\_name](#input\_application\_gateway\_resource\_group\_name) | Name of the Application Gateway resource group | `string` | n/a | yes |
| <a name="input_application_gateway_subnet_name"></a> [application\_gateway\_subnet\_name](#input\_application\_gateway\_subnet\_name) | Name of the Application Gateway subnet | `string` | n/a | yes |
